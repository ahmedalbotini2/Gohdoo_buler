...
//     // ✅ المفتاح السري بين التطبيق والسيرفر (وليس مفتاح Gemini)
...
//     override val analyzerType = AnalyzerType.LOCAL   // سيتم تغييره لـ REMOTE لاحقاً حسب الـ interface
...
//                         Log.e(TAG, "❌ مفتاح التطبيق غلط")
//                         AnalysisResult(false)
//                     }
//                     429 -> {
//                         Log.w(TAG, "⚠️ تجاوز الحد المجاني لـ Gemini")
//                         AnalysisResult(false)
//                     }
//                     else -> {
...
//             // تحويل regions لقائمة RectF (إحداثيات من 0.0 إلى 1.0)
...
// // موقع المنطقة الحساسة على الشاشة (إحداثيات 0.0–1.0)
// data class RegionResult(
//     val label:  String,
//     val bounds: RectF
// )

// // نتيجة التحليل — يجب تحديث AnalysisResult الموجود ليشمل هذه الحقول الجديدة
// // إذا AnalysisResult موجود مسبقاً كـ data class(isUnsafe: Boolean):
// // غيّره لـ:
// //
