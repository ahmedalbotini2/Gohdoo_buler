...
class MainActivity: FlutterActivity() {
    private val CHANNEL = "com.example.safety_screen/monitor"
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, CHANNEL).setMethodCallHandler { call, result ->
            when (call.method) {
                ...
                "isMonitoring" -> {
                    result.success(ScreenMonitorService.isMonitoring)
                }
                else -> {
    ...
    private fun startMonitoringFlow(result: MethodChannel.Result) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !Settings.canDrawOverlays(this)) {
            ...
            // In a production app, we should ideally use ActivityResultLauncher instead of startActivityForResult, 
            // but for simplicity and backwards compatibility we'll use this format and listen to onActivityResult.
        } else {
